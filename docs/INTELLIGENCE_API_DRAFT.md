...
**상태: 백엔드 미구현·미합의 초안. 실제 API 계약이 아닙니다.**

2026-09-18 원격 main 및 열린 PR을 확인했으며 B-15~16 선행 구현이 없습니다. 사용자 결정에 따라 이번 변경은 프론트엔드만 준비합니다. 서버 코드는 변경하지 않습니다. 백엔드 담당자는 아래 제안을 검토하고 확정 계약을 인계해야 합니다. 그 후 프론트엔드 어댑터와 통합 테스트를 맞춥니다.
