...
const companies = [{ companyId: 'A', name: 'A 엔터', description: '공연과 콘텐츠를 만드는 기업', currentPrice: 10000 }, { companyId: 'B', name: 'B IT', description: '캠퍼스 기술 서비스를 운영하는 기업', currentPrice: 20000 }]
let cash = 1000000
